...
jQuery(document).ready(function() {
	...
	$("#slider > div > ul > li").click(function() {
		$("body").addClass("slide_is_open");
		$("body.not-front #slider").animate({marginTop: "-15px"}, 500);
	});


	$('.breadcrumb a[href="/zabory"]').click(function(event){event.preventDefault();});
	...
	/*$('#our_works .our_works_carousel').jcarousel({
		visible: 5,
		wrap: 'circular',
		transitions: true
	});*/
	...
	/*$("a.prev_next").click(function(event) {
		event.preventDefault();
		if ($(this).hasClass('prev_carousel')) {
			$("#block-views-photogallery-front-block a.jcarousel-prev").trigger('click');
		} else {
			$("#block-views-photogallery-front-block a.jcarousel-next").trigger('click');
		};
	});*/
	...
	$(".arrows_up_down > span.down").click(function() {
		// if($(window).scrollTop() + $(window).height() < $(document).height()) {
			// $("html, body").animate({ scrollTop: height_scroll - 250}, 0);
